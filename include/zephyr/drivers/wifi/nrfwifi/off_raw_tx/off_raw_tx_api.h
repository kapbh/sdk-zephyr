 ...
 * - If CONFIG_WIFI_FIXED_MAC_ADDRESS is enabled, the MAC address is set to the value configured in the Kconfig.
 ...
 *
 */
int nrf70_off_raw_tx_conf_updt(struct nrf_wifi_off_raw_tx_conf *conf);
...
* the nRF70 device will start transmitting frames as per the configuration specified by conf.
*
* @retval 0 If the operation was successful.
* @retval -1 If the operation failed.
*
 ...
 *
 * This function is used to get statistics of offloaded raw TX operation. When this function is invoked
 * the nRF70 device will show statistics.
 *
 * @retval 0 If the operation was successful.
 * @retval -1 If the operation failed.
 *
